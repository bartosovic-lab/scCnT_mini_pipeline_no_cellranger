...
with open_file(args.fastq_R1) as f1, open_file(args.fastq_R2) as f2, open_file(args.fastq_R3) as f3, gzip.open(args.out_R1, 'wt') as g1, gzip.open(args.out_R3, 'wt') as g2:
